...
describe('Response Converter', () => {
  describe('convertResponseToAnthropic', () => {
    ...
    it('should convert upstream reasoning_content to Anthropic thinking before text', () => {
      const openaiResponse: OpenAIChatResponse = {
        ...
        choices: [
          {
            ...
            message: {
              role: 'assistant',
              reasoning_content: 'I need to inspect the request shape first.',
              content: 'The request shape is valid.',
            },
            finish_reason: 'stop',
          },
        ],
      ...
      expect(result.content[0]).toEqual({
        type: 'thinking',
        thinking: 'I need to inspect the request shape first.',
      });
      expect(result.content[1]).toEqual({
        type: 'text',
        text: 'The request shape is valid.',
      });
    });
    ...
    it('should tolerate missing usage data by falling back to zero token counts', () => {
